...
def main():
    ...
    print(f"   📈 Processed {data.get('files_processed', 0)} files with {data.get('items_added', 0)} items")
    ...
    if emerging_trends:
        ...
        print(f"      Top emerging: {top_emerging['name']} (momentum: {top_emerging['momentum']:.2f})")
