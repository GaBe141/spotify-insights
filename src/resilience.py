...
class EnhancedResilience:
        ...
        def decorator(func: Callable[..., T]) -> Callable[..., T]:
            ...
            async def async_wrapper(*args: Any, **kwargs: Any) -> Optional[T]:
                ...
                try:
                    ...
                    self.logger.warning(
                        f"Circuit '{name}' failure #{circuit.failures}: {str(e)}"
                    )
    ...
    def rate_limit(self, 
                   ...
                   burst_size: Optional[int] = None) -> Callable:
        """
    ...
    def get_performance_metrics(self, hours: int = 24) -> Dict[str, Any]:
        ...
        successful_requests = len([r for r in recent_requests if not r.get("error") and (r.get("status_code", 200) < 400)])
